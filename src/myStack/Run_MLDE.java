...
//				origData_train.getDataSet().attribute(0).isNominal();
				...
				MultiLabelInstances[] validDatas = findNeighbors(origData_train, origData_test, numBrothers, distMetricFlag);	//an instance in test data <==> a valid set
				MultiLabelInstances[] basedatas = bootStrap(origData_train);
//				dynamicEnsemble(null, origData_test, validDatas);
